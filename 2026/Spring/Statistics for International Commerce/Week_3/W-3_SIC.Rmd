...
Used to analyze relationships between two categorical variables.

Example:

Survey of movie attendance and gender.

|        | 0 Movies | ≥1 Movie | Total |
| ------ | -------- | -------- | ----- |
| Male   | 20       | 50       | 70    |
| Female | 40       | 40       | 80    |
| Total  | 60       | 90       | 150   |
...
Probability person attended zero movies:

P(0 movies) = 60 / 150 = 0.40

---

# Conditional Probability Example

Probability attended zero movies **given male**:
...
Python uses different **data types** to represent different kinds of data.
...
.tiny[[Our classroom on DataCamp](https://app.datacamp.com/groups/statistics-for-international-commerce-7c670aae-048d-456e-8a54-892baebf8ad2/dashboard)]
</div>
...
> Let's use Google Colab to practice with this dataset.
...
Create your own dataset of export values for 5 countries (real or hypothetical).
