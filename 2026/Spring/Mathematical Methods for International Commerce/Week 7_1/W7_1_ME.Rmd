...
- APL = MPL identifies interior maximum of APL (if solution is positive)

- Here solution is $𝐿=0$, so no economically meaningful interior maximum

- Check this function $Q=20L−L2+10$.
---
...
### Setup:
- Form **6 teams** of **4-5 students** each.
...
- (April 16) The Derivative of the Exponential and Natural Log Functions (4.8) 
