...
- Use inspection and linearity rules to integrate polynomial and exponential functions
...
- From economics perspective, $C$ often represents fixed costs or baseline values in economic applications.
- In practice, we often determine $C$ using initial conditions or boundary values.

---

# Indefinite Integration: Water Tank Analogy

<div>
.center[
<img src="p33.png" width="90%">
]
...
- Interpretation:
  ...
  - The constant $C$ represents the initial value of total revenue when output is zero.
...
- If $MPS=s$, then integrating gives the savings function $S(Y)=sY+C$.
...
**Format:** 6 groups, 4-5 students each. Each group receives a distinct problem.  
...
# Group 1: Marginal Cost and Total Cost
...
1. Find the total cost function by integration.

2. If fixed cost is $80, determine the constant of integration.

3. Interpret the meaning of the fixed cost economically.

---

# Group 2: Marginal Revenue and Total Revenue
...
1. Find the total revenue function by integration.

2. Assume total revenue is zero when output is zero. Determine the constant of integration.

3. At what output level does marginal revenue become zero?

---

# Group 3: Consumption Function
...
1. Integrate to find the consumption function.

2. If autonomous consumption is $120, determine the full consumption function.

3. Explain economically what the MPC means.

---

# Group 4: Savings Function
...
1. Integrate to find the savings function.

2. If initial savings are \(-\$50\) when income is zero, determine the full savings function.

3. Interpret the meaning of negative initial savings and positive marginal propensity to save.

---

# Group 5: Investment Accumulation

A firm’s marginal investment function is:
...
2. Assume accumulated investment is zero at ( t = 0 ). Determine the constant of integration.

3. Calculate the accumulated investment after 5 years.

---

# Group 6: Marginal Benefit and Total Benefit

A consumer’s marginal benefit function is:

$$
MB(Q) = 20 - 2Q
$$

1. Integrate to find the total benefit function.

2. Assume total benefit is zero when quantity is zero. Determine the constant of integration.

3. Explain why total benefit increases at a decreasing rate.
...
- (May 21) Definite Integration (6.2) 
...
getwd()
setwd("C:\\Users\\vyshn\\OneDrive - kdis.ac.kr\\Documents\\GitHub\\Sogang\\2026\\Spring\\Mathematical Methods for International Commerce\\Week 12_1")
