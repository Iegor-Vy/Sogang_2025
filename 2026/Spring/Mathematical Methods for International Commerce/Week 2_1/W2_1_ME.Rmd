...
- A company operates in Eurozone, so it cashes out in **EUR**.

- A company must pay **$200,000 annually** for a loan (cash outflow).
...
- ER = Exchange rate **(USD per EUR, USD/EUR)**
...
A company borrows **$1,000,000 USD** (principal/obligation), and the exchange rate is **1 EUR = 1.10 USD**, with a **€50,000 commission**.
...
# Graphical Solution of a 3x3 System of Equations
...
## Please solve the following 3x3 systems of equations:
...
- (Mar 12) Supply and Demand Analysis (1.5), Transposition of Formulae (1.6), National Income Determination (1.7) 
...
getwd()
setwd("C:\\Users\\vyshn\\OneDrive - kdis.ac.kr\\Documents\\GitHub\\Sogang\\2026\\Spring\\Mathematical Methods for International Commerce\\Week 2_1")
