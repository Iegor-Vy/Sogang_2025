...
- $C = wL + rK$
- Find the marginal cost with respect to labor and capital
...
- Marginal cost with respect to labor: \( MC_L = w \)
- Marginal cost with respect to capital: \( MC_K = r \)
**Interpretation:**
...
- \( MU_y = 0.5x^{0.5}y^{-0.5} \)
- \( MRCS = \left| \frac{MU_x}{MU_y} \right| = \left| \frac{y}{x} \right| \)
- To maintain utility while giving up 1 unit of \( y \), the consumer needs \( \frac{y}{x} \) units of \( x \).
