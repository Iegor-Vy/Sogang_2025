...
subtitle: "<br/>Week 14/2: Linear Programming (8.1)"
...
- Boundary line itself is included only for $\leq$ or $\geq$
...
- Test point $(0,0)$: inequality holds → region of interest is below the line (shade above)
...
- All objective lines are parallel because slope stays constant
- Optimization means shifting this line until it last touches the feasible region
...
- (June 9) Applications of Linear Programming (8.2)   
...
getwd()
setwd("C:\\Users\\vyshn\\OneDrive - kdis.ac.kr\\Documents\\GitHub\\Sogang\\2026\\Spring\\Mathematical Methods for International Commerce\\Week 14_2")
