...
- **UU.S. Treasury** securities are generally treated as default-risk-free in textbook analysis.
...
> Lower yields on municipal bonds partly reflect tax advantages, so yield comparisons with Treasuries should be interpreted carefully.
---
...
- Under the pure expectations theory, the long-term yield is approximately the average of expected future short-term rates.
...
- The yield curve contains information about expected future short-term rates and often about future economic conditions. 

- A flat or inverted curve has historically been a recession warning signal, not a guarantee.
...
- The New York Fed’s recession model based on the Treasury spread showed a 12-month-ahead recession probability of about 44.6% for February 2026. That is useful and more precise than the current sentence.

- Yield-curve inversion has often preceded U.S. recessions, but it is not a mechanical rule. The New York Fed’s Treasury-spread model estimated the 12-month-ahead recession probability at about 44.6% in February 2026.
...
- In the long run, stock value depends on expected cash flows to shareholders. These may come through dividends and, in practice, also through share repurchases.
...
1. Market price is determined by *trading among buyers and sellers* and is often interpreted as reflecting the valuation of the marginal investor.
...
> When policy rates fall, stocks may rise not only because discount rates fall, but also because investors expect stronger future earnings.
...
> Under rational expectations, forecasts use all available information and are unbiased on average.

---

## Efficient Market Hypothesis (EMH)

- In the semi-strong form of EMH, *asset prices rapidly incorporate all publicly available information*.
...
> EMH does not say prices are always ‘right’; it says abnormal profits based on public information should be hard to earn consistently.
...
- Consistently beating the market using public information is difficult.
...
- Large price swings may reflect changing expectations, risk premia, liquidity conditions, and behavioral forces.
...
- Each student will give a **10-minute presentation** followed by a **2-minute Q&A session**.
...
- Sovereign Debt Stress in a High-Rate World
...
- FinTech, Big Tech, and Competition in Payments and Lending
...
- Higher-for-Longer Interest Rates: Who Wins and Who Loses?
...
- Nonbank Financial Intermediation and Systemic Risk
- Treasury Market Liquidity and Why It Matters
- Private Credit: Opportunity or Hidden Fragility?
...
- You must **submit the final version of your presentation slides** via Cyber Campus by **June 11 at 12:00 PM (noon)**.
- Prepare a presentation of **10–12 slides** (PowerPoint, PDF, or equivalent).
- You will have **10 minutes to present**, followed by a **2-minute Q&A**.
...
getwd()
setwd("C:\\Users\\vyshn\\OneDrive - kdis.ac.kr\\Documents\\GitHub\\Sogang\\2026\\Spring\\Financial Institutions and System\\Week 5")
