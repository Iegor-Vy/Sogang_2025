...
3. Class Activity: Han River Bikes Co. Choosing how to raise funds 
...
- **Eurobonds** – bonds denominated in a currency *different* from the country where they are issued.  
...
- **Capital Requirements** – Ensures banks hold sufficient capital (*Basel Accords*).  
...
**Key Questions:**  
1. How do **financial markets** facilitate capital allocation and economic growth?  

2. In what ways do **financial intermediaries** reduce **transaction costs** and **manage risk**?  

3. Why is **regulation** crucial for financial stability and investor protection?

4. What are the **risks** associated with financial markets and institutions?

5. How can financial institutions **mitigate risks** and **ensure market integrity**?

6. What are the **benefits** and **challenges** of international financial markets?  
...
# 3. Class Activity: Han River Bikes Co. Choosing how to raise funds
Please check the Week 2 CyberCampus folder for the case study materials. 

---

# Next Class

- (Mar 19) Chap 3. What is money?
...
getwd()
setwd("C:\\Users\\vyshn\\OneDrive - kdis.ac.kr\\Documents\\GitHub\\Sogang\\2026\\Spring\\Financial Institutions and System\\Week 2")
