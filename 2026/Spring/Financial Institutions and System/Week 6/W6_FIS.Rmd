...
> Even today, public equity is not the dominant source of external finance for most firms; bank loans, retained earnings, and private credit remain much more important.
...
- Use screening, monitoring, diversification, and relationship lending to improve risk-adjusted returns.
...
> More recent examples such as Silicon Valley Bank (2023) show that even with strong disclosure, markets and supervisors can underestimate liquidity and interest-rate risk.
...
- For debt contracts, moral hazard becomes especially important when borrower actions increase the probability of default or reduce lender protection.
...
> This is also why credit access often depends on legal identity, credit history, and property rights—not only income.
...
- **Checkable deposits** (transaction accounts used for payments): allow account holders to write checks.
  - 14% of bank liabilities (June 2020)
  - Declined from 60% in the 1960s
  - Lowest-cost source of bank funds

- **Nontransaction deposits** (savings and time deposits):
  - No check-writing privileges
  - Include savings and time deposits
  - 63% of liabilities (June 2020)

> Deposit composition has shifted over time, with transaction and savings accounts now dominating traditional retail funding.
...
> In practice, banks today also rely heavily on wholesale funding and market-based borrowing.
...
- **Reserves**: deposits at the Fed + vault cash
  - Used mainly for payments, liquidity, and settlement
  - Banks may still hold large reserve balances even though reserve requirements are now zero in the U.S.

- **Deposits at other banks**:
  - Small banks hold funds at larger banks for services
  - Reserves + deposits = ~15% of assets

> Since March 2020, the Federal Reserve has set reserve requirement ratios to zero percent for all depository institutions to support liquidity in the financial system during the COVID-19 pandemic.
...
> Commercial banks generally hold mostly debt securities and loans rather than common equity as core balance-sheet assets
...
> In modern systems, reserve changes are closely tied to central bank operating procedures and payment settlement, not just textbook reserve multipliers.
...
If a bank wants to maintain a liquidity buffer equal to 10% of deposits, then:
...
> In periods of stress, central banks may also create temporary liquidity facilities to support banks and prevent fire sales of assets.

.tiny[The Fed’s Bank Term Funding Program (BTFP) stopped making new loans in March 2024 and was designed to help banks meet liquidity needs during the 2023 stress episode.]
...
> Capital rules today are shaped by Basel III, which strengthened risk-based capital and liquidity requirements after the Global Financial Crisis.
...
> In practice, raising new equity during stress can be difficult and expensive, which is why capital shortfalls often lead to balance-sheet contraction
...
> A similar mechanism reappeared in 2023 when unrealized losses on securities and deposit outflows increased pressure on some regional banks.
...
.center[<img src="inter.jpg" height="70%" width="70%">]
...
> This is exactly why banks with long-duration assets and short-term funding can become vulnerable when rates rise quickly.
...
> Banks also use deposit pricing, hedging, and balance-sheet reallocation to manage rate exposure
...
> Today, financial intermediation is increasingly shared between banks and nonbank financial institutions such as money market funds, private credit funds, insurers, and investment funds. The FSB reported NBFI assets of $256.8 trillion in 2024.
...
getwd()
setwd("C:\\Users\\vyshn\\OneDrive - kdis.ac.kr\\Documents\\GitHub\\Sogang\\2026\\Spring\\Financial Institutions and System\\Week 6")
