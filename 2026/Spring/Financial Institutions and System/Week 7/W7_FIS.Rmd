...
subtitle: "<br/>Week 7: Economic Analysis of Financial Regulation<br/>Banking Industry: Structure and Competition"
...
- Today, FDIC insurance covers $250,000 per depositor, per insured bank, per ownership category.
...
- Under payoff, insured depositors are paid quickly up to insured limits; the FDIC then recovers value through the receivership process.
...
- The 2023 regional bank failures showed that contagion can also spread through uninsured deposits, rapid digital withdrawals, and interest-rate risk.” SVB failed after realizing losses on securities while trying to raise capital, and First Republic later experienced severe contagion and liquidity stress.
...
- Strongly limit direct equity holdings and concentration in risky assets.
...
> Leverage and risk-based capital requirements vary by jurisdiction and institution type.
---
...
> This was the original Basel I framework; later Basel reforms became much more risk-sensitive.
---
...
> Post-2008 reforms strengthened capital and liquidity rules, but the 2023 bank failures showed that interest-rate risk and uninsured deposit concentration still matter.
---
...
> Disclosure improves market discipline, but it does not eliminate panic if markets react suddenly to bad news.
---
...
> Basel III implementation remains an active international priority in 2025–26.” The Basel Committee’s 2025–26 work programme explicitly lists Basel III implementation, and BIS reported further implementation progress through end-September 2025
---
...
- National Bank Act of 1863:
  ...
  - Office of the Comptroller of the Currency (OCC) created
  - Dual banking system
...
- State authorities: state-chartered banks alongside federal supervisors
...
# Supply-Side Innovations: Technology and Financial Engineering
...
> Nonbank financial intermediation continues to grow globally; the FSB reported NBFI assets of $256.8 trillion in 2024, with growth double the pace of the banking sector
---
...
> Historically, reserve requirements acted like a tax on some deposit funding. Banks responded through disintermediation, money market funds, and sweep accounts. In the U.S., reserve requirement ratios were reduced to zero in 2020.
...
- The SEC adopted major money market fund reforms in 2023, including higher liquidity requirements and the removal of gates that allowed temporary suspension of redemptions.
---
...
- Reserves = liquidity and settlement balances
- Excess reserves = liquidity buffer
...
> In recent stress episodes, central banks also created special liquidity facilities, not only standard discount-window lending
---
...
> A similar mechanism appeared in 2023, when unrealized losses and deposit outflows put pressure on regional banks.
...
- (April 23) Midterm Exam (09:15-11:45) 
...
getwd()
setwd("C:\\Users\\vyshn\\OneDrive - kdis.ac.kr\\Documents\\GitHub\\Sogang\\2026\\Spring\\Financial Institutions and System\\Week 7")
