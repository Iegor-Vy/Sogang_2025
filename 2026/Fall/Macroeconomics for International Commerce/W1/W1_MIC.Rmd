---
title: "Macroeconomics for International Commerce"
subtitle: "<br/>Lecture 1: Course Overview & Why Macroeconomics"
...
⚠️ The effect on net exports and competitiveness depends on imports, imported inputs, prices, and the exchange rate.
...
⚠️ **Main risk:** If persistent, it erodes purchasing power and creates uncertainty.

⚠️ Distributional effects depend on whether inflation is expected and whether wages and contracts adjust.
...
.tiny[Example: [Stanford Digital Economy Lab, *Canaries in the Coal Mine?*](https://digitaleconomy.stanford.edu/publication/canaries-in-the-coal-mine-six-facts-about-the-recent-employment-effects-of-artificial-intelligence/)]
...
⚠️ **Main risk:** Credit-fueled price increases can raise the risk of a crash and financial instability.

⚠️ In the short run, wealth effects and construction can boost demand—even while longer-run risks accumulate.
...
**In short:**  
Macroeconomics helps us ask better questions before jumping to conclusions.
...
- **Office Hours**: Tue/Thu 15:00–16:30 and Wed 10:00–12:00 (or by appointment) 
...
- **Our goals**
  ...
  - See that macroeconomics can be .orange[fun] :-)
...
<div>
.center[<img src="p21.jpg" height="50%" width="50%">]

.tiny[Image used as a discussion prompt; original creator unknown.]
...
Form **six groups of 4–5 students**. Each group advises one stakeholder:
...
Choose a **facilitator**, **recorder**, **reporter**, and **timekeeper**.
...
<div>
.center[<img src="Pic_4.png" height="70%" width="70%">]

Source: [Economy 2.0](https://books.core-econ.org/the-economy/microeconomics/01-prosperity-inequality-13-economics-biosphere.html).
...
<div>
.center[<img src="Pic_1.png" height="50%" width="50%">]


.tiny[Source: Xu et al. (2011), “Interconnectedness and Resilience of the U.S. Economy,” *Advances in Complex Systems*, 14(5), 649–672.]
...
* Read a macro dashboard (GDP, inflation, policy rate, FX).

* Explain **what changed**, **likely policy direction**, and **an implication for pricing/trade**.

* Write concise notes to decision-makers.
...
**In short:** Macroeconomics helps you see the *big picture* of economies —  how shocks, policies, and institutions affect prosperity and stability.
...
* Carlin & Soskice (2024), *Macroeconomics: Institutions, Instability and Inequality* ([free PDF via Wendy Carlin’s Google Site](https://sites.google.com/site/wendycarlinucl/new-book))

**Additional**

* Mankiw (2024), *Principles of Macroeconomics*, 10e
* CORE Team (2024), *The Economy 2.0: Macroeconomics* ([free e-book](https://www.core-econ.org/the-economy/))
...
2. **Language barrier:** focus first on the logic, then the vocabulary.
...
renderthis::to_pdf("W1_MIC.html")

getwd()
setwd("C:\\Users\\vyshn\\OneDrive - kdis.ac.kr\\Documents\\GitHub\\Sogang\\2026\\Fall\\Macroeconomics for International Commerce\\W1")
